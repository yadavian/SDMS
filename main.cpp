...
void insertStudentByAdmin()
{
    ...
    if (rn != temp)
    {
        ...
        if (state == 0)
        {
            ...
            cout << "\n\t\t\t\tpress y to add more details"<<endl;
            cout << "\n\t\t\t\tpress any key to go back to Menu......."<<endl<<"\n\t\t\t\t";
            string desicion;
            cin>>desicion;
            if(desicion=="y")
...
void deleteStudentByAdmin()
{
    ...
    else
    {
        ...
        if (state == 0)
        {
            ...
            cout << "\n\t\t\t\tpress y to delete more details"<<endl;
            cout << "\n\t\t\t\tpress any key to go back to Menu......."<<endl<<"\n\t\t\t\t";
            string desicion;
            cin>>desicion;
            if(desicion=="y")
...
void searchSingleStudent()
{
    ...
    else
    {
        ...
        if (!state)
        {
            ...
            cout << "\n\t\t\t\tpress y to search more  details"<<endl;
...
void deleteMarksByAdmin()
{
    ...
    else
    {
        ...
        {
            cout << "\n\t\t\t\tDELETED STUDENT OF ROLL NUMBER = " << rn << "\n\n\n"<< endl;
            cout << "\n\t\t\t\tpress y to delete more  result"<<endl;
            cout << "\n\t\t\t\tpress any key to go back to Menu......."<<endl<<"\n\t\t\t\t";
            string desicion;
            cin>>desicion;
            if(desicion=="y" || desicion=="Y")
...
void searchSingleMarks()
{
    ...
    else
    {
        ...
        if (!state)
        {
            ...
            cout << "\n\t\t\t\tpress y to search more  result" << endl;
            cout << "\n\t\t\t\tpress any key to go back to Menu......." << endl
                 << "\n\t\t\t\t";
            string desicion;
            cin >> desicion;
...
void updateStudentByAdmin()
{
    ...
    else
    {
        ...
        if (state == 0)
        {
            ...
            cout << "\n\t\t\t\tpress y to update more  details"<<endl;
            cout << "\n\t\t\t\tpress any key to go back to Menu......."<<endl<<"\n\t\t\t\t";
            string desicion;
            cin>>desicion;
            if(desicion=="y" || desicion=="Y")
